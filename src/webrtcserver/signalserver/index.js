...
const sdpCache = new NodeCache({ stdTTL: 3600 }); // Cache SDPs for 1 hour


 // case 'register':
 // sdpCache.set(peerId, sdp);

 // case 'offer':
 // if (sdpCache.has(peerId)) {
 //             ws.send(JSON.stringify({ type: 'answer', sdp: sdpCache.get(peerId) }));
 // }
