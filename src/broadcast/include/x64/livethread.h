...
class Recording:public base::Thread
{
    ...
    Recording( st_track *trackInfo,  LiveConnectionContext *ctx):trackInfo(trackInfo),ctx(ctx)
    {
    }
...
//   */
//    
//    LiveThread(const char* name, st_track *trackInfo, LiveConnectionContext* ctx, bool &recording);
//    
//    void onMessage(json &msg );
//    
//    
