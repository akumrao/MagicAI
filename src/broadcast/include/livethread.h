...
struct LiveConnectionContext {                                                                        
  ...
  connection_type(ct), address(address), slot(slot), cam(cam), framefilter(framefilter),info(info), txt(txt), msreconnect(5000),       
  ...
  connection_type(LiveConnectionType::none), address(""), slot(0), framefilter(NULL),info(NULL),txt(NULL), msreconnect(5000), 
