...
struct AudioEncoderG711_Cam
{
    struct Config
    {
        ...
        bool IsOk() const
        {
            return (type == Type::kPcmU || type == Type::kPcmA) && frame_size_ms > 0 && frame_size_ms % 10 == 0
                && num_channels >= 1;
        }
    ...
    static absl::optional<AudioEncoderG711_Cam::Config> SdpToConfig(const webrtc::SdpAudioFormat &audio_format);
