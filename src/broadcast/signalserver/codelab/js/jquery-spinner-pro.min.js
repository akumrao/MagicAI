/*! For license information please see jquery-spinner.min.js.LICENSE.txt */
!(function (e, t) {
            ...
            !(function (t, n) {
                ...
                var S = (function (e) {
                              ...
                              (n.qsa = K.test(d.querySelectorAll)) &&
                                  (ce(function (e) {
                                      ...
                                      (h.appendChild(e).innerHTML = "<a id='" + b + "'></a><select id='" + b + "-\r\\' msallowcapture=''><option selected=''></option></select>"),
                                          ...
                                          e.querySelectorAll("[selected]").length || v.push("\\[" + M + "*(?:value|" + I + ")"),
                    ...
                    (se.matchesSelector = function (e, t) {
                        if ((p(e), n.matchesSelector && g && !j[t + " "] && (!y || !y.test(t)) && (!v || !v.test(t))))
                            try {
                                var r = m.call(e, t);
                            ...
                            var t = [
                                ...
                                i = {
                                    ...
                                    then: function (e, r, i) {
                                                    ...
                                                    l = function () {
                                                        ...
                                                        if (!(e < o)) {
                                                            ...
                                                            (l = n && ("object" == typeof n || "function" == typeof n) && n.then),
                                                                y(l)
                                                                    ? i
                                                                        ? l.call(n, a(o, t, R, i), a(o, t, _, i))
                                                                        : (o++, l.call(n, a(o, t, R, i), a(o, t, _, i), a(o, t, R, t.notifyWith)))
                                        ...
                                        return C.Deferred(function (n) {
                                            t[0][3].add(a(0, n, y(i) ? i : R, n.notifyWith)), t[1][3].add(a(0, n, y(e) ? e : R)), t[2][3].add(a(0, n, y(r) ? r : _));
                                        }).promise();
                                    },
                                    promise: function (e) {
                ...
                (C.fn.ready = function (e) {
                    ...
                    (C.ready.then = B.then),
                    "complete" === x.readyState || ("loading" !== x.readyState && !x.documentElement.doScroll) ? n.setTimeout(C.ready) : (x.addEventListener("DOMContentLoaded", $), n.addEventListener("load", $));
                            ...
                            for (
                                ...
                                (d = g = (s = Se.exec(t[l]) || [])[1]),
                                    ...
                                    d &&
                                        ...
                                        (f = C.event.special[d] || {}),
                                        (c = C.extend({ type: d, origType: g, data: r, handler: n, guid: n.guid, selector: i, needsContext: i && C.expr.match.needsContext.test(i), namespace: h.join(".") }, o)),
                            ...
                            for (a = C.event.handlers.call(this, u, l), t = 0; (i = a[t++]) && !u.isPropagationStopped(); )
                                for (u.currentTarget = i.elem, n = 0; (o = i.handlers[n++]) && !u.isImmediatePropagationStopped(); )
                                    (u.rnamespace && !1 !== o.namespace && !u.rnamespace.test(o.namespace)) ||
                                        ((u.handleObj = o),
                                        (u.data = o.data),
                                        void 0 !== (r = ((C.event.special[o.origType] || {}).handle || o.handler).apply(i.elem, s)) && !1 === (u.result = r) && (u.preventDefault(), u.stopPropagation()));
                    ...
                    (C.Event = function (e, t) {
                        ...
                        e && e.type
                            ? ((this.originalEvent = e),
                              (this.type = e.type),
                              (this.isDefaultPrevented = e.defaultPrevented || (void 0 === e.defaultPrevented && !1 === e.returnValue) ? ke : je),
                            ...
                            for (c = a[a.length - 1].ownerDocument, C.map(a, Ie), f = 0; f < s; f++)
                                (l = a[f]),
                                    ye.test(l.type || "") &&
                                        ...
                                        C.contains(c, l) &&
                                        (l.src && "module" !== (l.type || "").toLowerCase() ? C._evalUrl && !l.noModule && C._evalUrl(l.src, { nonce: l.nonce || l.getAttribute("nonce") }, c) : w(l.textContent.replace(He, ""), l, c));
                    }
                    return e;
                }
                function We(e, t, n) {
                ...
                C.extend({
                    ...
                    clone: function (e, t, n) {
                        var r,
                            ...
                            s = e.cloneNode(!0),
                            u = ae(e);
                        if (!(v.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || C.isXMLDoc(e))) for (a = xe(s), r = 0, i = (o = xe(e)).length; r < i; r++) Re(o[r], a[r]);
                        if (t)
                ...
                function Ue(e, t, n) {
                    ...
                    return (
                        (n = n || Be(e)) &&
                            ...
                            !v.pixelBoxStyles() && Fe.test(a) && ze.test(t) && ((r = s.width), (i = s.minWidth), (o = s.maxWidth), (s.minWidth = s.maxWidth = s.width = a), (a = n.width), (s.width = r), (s.minWidth = i), (s.maxWidth = o))),
                        void 0 !== a ? a + "" : a
                    );
                }
                function Xe(e, t) {
                        ...
                        function (e, t, n) {
                            ...
                            if ((u = !C.isEmptyObject(t)) || !C.isEmptyObject(d))
                                for (r in (f &&
                                    ...
                                    "none" === (c = C.css(e, "display")) && (l ? (c = l) : (pe([e], !0), (l = e.style.display || l), (c = C.css(e, "display")), pe([e]))),
                ...
                function qt(e, t, n, r) {
                    ...
                    if (Array.isArray(t))
                        C.each(t, function (t, i) {
                            n || jt.test(e) ? r(e, i) : qt(e + "[" + ("object" == typeof i && null != i ? t : "") + "]", i, n, r);
                        });
                ...
                (Ft.href = Et.href),
                    C.extend({
                        ...
                        ajax: function (e, t) {
                            ...
                            if ((d.data && d.processData && "string" != typeof d.data && (d.data = C.param(d.data, d.traditional)), $t(Rt, d, t, E), l)) return E;
                            ...
                            E.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + Wt + "; q=0.01" : "") : d.accepts["*"]),
                            d.headers))
                                E.setRequestHeader(f, d.headers[f]);
                            if (d.beforeSend && (!1 === d.beforeSend.call(h, E, d) || l)) return E.abort();
                            if (((T = "abort"), y.add(d.complete), E.done(d.success), E.fail(d.error), (r = $t(_t, d, t, E)))) {
                            ...
                            function S(e, t, a, u) {
                                ...
                                l ||
                                    ...
                                    y.fireWith(h, [E, T]),
                                    c && (g.trigger("ajaxComplete", [E, d]), --C.active || C.event.trigger("ajaxStop")));
                            }
                            return E;
                        },
        ...
        function (e, t, n) {
            ...
            var a = (function () {
                function e(t) {
                    ...
                    var n = Object.assign({ duration: 300, created: !0 }, t);
                    (this.parentId_ = n.parentId), (this.appendId_ = "_spinner_wrap"), (this.overlayId_ = "".concat(this.parentId_).concat(this.appendId_)), (this.duration_ = n.duration), n.created && this.createElement();
                }
                var t, n, r;
                return (
                    (t = e),
                    (n = [
                        {
                            ...
                            value: function () {
                                try {
                                    var e = i()("#".concat(this.parentId_)),
                                        t = '<div id="'.concat(this.overlayId_, '" class="jquery-spinner-wrap"><div class="jquery-spinner-circle"><span class="jquery-spinner-bar"></span><span class="jquery-spinner-bar"></span> <span class="jquery-spinner-bar"></span> <span class="jquery-spinner-bar"></span> </div></div>'),
                                        n = i.a.parseHTML(t);
                                    e.append(n);
                                } catch (e) {
                                    console.error(e);
                        ...
                        },
                        {
                            ...
                            value: function () {
                                try {
                                    i()("#".concat(this.overlayId_)).remove();
                                } catch (e) {
                                    console.error(e);
                                }
                            },
                        },
                        {
                            key: "show",
                            value: function () {
                                i()("#".concat(this.overlayId_)).fadeIn(this.duration_);
                            },
                        },
                        {
                            key: "hide",
                            value: function () {
                                i()("#".concat(this.overlayId_)).fadeOut(this.duration_);
                            },
                        },
                    ]) && o(t.prototype, n),
                    r && o(t, r),
